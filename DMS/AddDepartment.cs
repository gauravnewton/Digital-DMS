        ...
        private void metroButton2_Click(object sender, EventArgs e)
        {
            if (metroTextBox1.Text != "")
            {
                try
                {
                    ...
                    MySqlCommand cmd2;
                    string CmdString = "insert into department(department) values(@department);";
                    cmd2 = new MySqlCommand(CmdString, con);
                    cmd2.Parameters.Add("@department", MySqlDbType.VarChar, 100);
                    ...
                    {
                        con.Close();
                        MetroMessageBox.Show(this.MdiParent, "\nDepartment Added Successfully !", "Alert", MessageBoxButtons.OK, MessageBoxIcon.Question);
                        this.Dispose();
                    }
                    else
                    {
